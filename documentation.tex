...
It is worth mentioning that the robustness comes at an additional cost, which is, in worst case scenario, planet would require one complete revolution before being able to escape from \texttt{TOO\_CLOSE} region of star. 
\section{Code}
\lstset{
	language=C,
	numbers=left,
