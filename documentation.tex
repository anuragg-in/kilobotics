...
\chapter{Programming the Kilobots}
In this chapter, we program the Kilobots (using the Kilobotics software) to perform certain tasks.  
...
\begin{figure}[H]
    \centering
	\includegraphics[scale=0.5]{images/sync-algo}
