...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=2.5in]{images/orbit_after_escape}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=2.5in]{images/orbit_two_stars_comm_1}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=2.5in]{images/orbit_two_stars}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=2.5in]{images/orbiting_three_stars}}
