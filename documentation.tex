...
\end{itemize}
\section{Demonstration}
Figure \ref{fig:efficient_star_planet_orbiting} provides the link to the demo for orbiting of planet around the star given star starts near the desired distance.
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[scale=0.4]{images/efficient_orbiting}}
    \caption{\href{https://photos.app.goo.gl/A}{Efficient star-planet orbiting}}
